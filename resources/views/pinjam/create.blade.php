...
<div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form class="user" method="post" action="{{ route('pinjam.store') }}">
                        @csrf

                    <div class="form-group">
                          <Label>No Referensi :</Label>
                          <input type="text" class="form-control" id="noReferen" name="no_ref" readonly>
                    </div>

                    <div class="form-group">
                          <Label>No Customer :</Label>
                          <input type="text" class="form-control" id="noCustomer" name="no_cus" readonly>
                    </div>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="lamaPinjam" readonly class="form-control" name="lama_pinjam" placeholder="Lama Pinjam">
                      </div>
                      
                      <div class="form-group">
                        <Label>Tanggal Pinjam :</Label>
                        <input type="date" id="tglPinjam" class="form-control" name="tgl_pinjam" placeholder="Tanggal Pinjam">
                      </div>

                      <div class="form-group">
                          <Label>Tanggal Kembali :</Label>
                          <input type="date" id="tglKembali" class="form-control" name="tgl_kembali" placeholder="Tanggal Kembali">
                      </div>
                      
                      <div class="form-group">
                          <Label>Jumlah Pinjam :</Label>
                          <input type="text" id="jmlhPinjam" class="form-control" name="jumlah_pinjam" placeholder="Berapa Jumlah Pinjam?">
                      </div>

                      <div class="form-group">
                          <Label>Sisa Stok :</Label>
                          <input type="text" id="sisaStok" readonly class="form-control" name="sisa_stok" >
                      </div>
          ...
          <script>
            ...
            const noReferen = document.getElementById('noReferen');
            const valueReferen = @json($pinjam->pluck('id')->toArray());
            if(!valueReferen.length) {
              noReferen.value = 'PM001';
            } else {
              let referenKey = valueReferen.length + 1;
              noReferen.value = 'PM00' + referenKey;
            }
          </script>
@endsection