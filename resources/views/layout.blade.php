	...
	<!-- Bagian Penutup Judul Template -->
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Isi Menu:</h6>
            <a class="collapse-item" href="{{ route('customer.index') }}">Data Customer</a>
            <a class="collapse-item" href="cards.html">Data Belanja Customer</a>
            <a class="collapse-item" href="cards.html">Voucher Customer</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Isi Menu:</h6>
            <a class="collapse-item" href="{{ route('kendaraan.index') }}">Data Kendaraan</a>
            <a class="collapse-item" href="utilities-border.html">Data Sopir</a>
            <a class="collapse-item" href="utilities-animation.html">Voucher Kendaraan</a>
            <a class="collapse-item" href="{{ route('pinjam.index') }}">Data Pinjam</a>
          </div>
        </div>
      </li>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; SISFO Akademik 2019</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
